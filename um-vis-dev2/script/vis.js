...
function actOpen(resId, actIdx) {
  ...
  if(res.dim){
      ...
      ui.vis.act.frame.style.width = 0.5*display_width + "px";
      ui.vis.act.frame.style.height = display_height + "px";
      
      ui.vis.act.fbConceptual.style.width = 0.49*display_width + "px";
      ui.vis.act.fbConceptual.style.height = display_height + "px";
 ...
 // }
  //@@@Jordan@@@
  act.url = act.url.replace("http://pawscomp2.sis.pitt.edu/quizjet","http://localhost:8080/QuizJET");//Replace official QuizJet call for the local version on localhost
  console.log(act.url);
...
//    };
    ...
    ui.vis.act.fbConceptual = $("#act-fb-conceptual")[0];//@Jordan
